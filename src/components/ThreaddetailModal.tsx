...
export default function ThreadDetailModal({
    ...
    //         addToast({ title: "Closed", description: "Thread closed.", color: "success" });
    //         onOpenChange(false);
    //         onThreadClosed();
    //     } catch (err) {
    //         addToast({ title: "Error", description: getSupportErrorMessage(err), color: "danger" });
                                ...
                                <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <div className="flex flex-col gap-0.5 mt-0.5">
                                            ...
                                            {selectedThread?.user.mobile && (
                                                <InfoRow icon="mdi:phone-outline" value={selectedThread.user.mobile} />
                                            )}
                                        </div>
                                    </div>
                                </div>

                                {/* Right: status + thread id */}
                                <div className="flex mt-5 flex-col items-end gap-1 shrink-0">
                                    <Chip
                                        size="sm"
